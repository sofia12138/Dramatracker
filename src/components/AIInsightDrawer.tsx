...
export default function AIInsightDrawer({ open, onClose }: Props) {
  ...
  return (
    <>
      ...
      <div className="fixed right-0 top-0 h-full w-[600px] bg-primary-card z-50 shadow-2xl flex flex-col">
        <div className="sticky top-0 bg-primary-card border-b border-primary-border px-6 py-4 flex items-center justify-between z-10">
          ...
          <div className="flex items-center gap-2">
            {content && !loading && (
              <>
                <button onClick={handleCopy}
                  className="p-1.5 hover:bg-primary-sidebar rounded-lg transition-colors text-primary-text-muted" title="复制">
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
                  </svg>
                </button>
                <button onClick={handleRegenerate}
                  className="p-1.5 hover:bg-primary-sidebar rounded-lg transition-colors text-primary-text-muted" title="重新生成">
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <button onClick={handleClose} className="p-1.5 hover:bg-primary-sidebar rounded-lg transition-colors">
